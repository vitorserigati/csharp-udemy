...
A empresa utiliza um **serviço de pagamento** online para quealizar o pagamento das parcelas. Os serviços de pagamento online tipicamente cobram um juro mensal, bem como uma taxa por pagamento. Por enquanto, o serviço contratado pela empresa é o do Paypal, que aplica ***juros simples*** de 1% a cada parcela, mais uma ***taxa*** de pagamento de 2%.
